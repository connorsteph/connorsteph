...
Prior to my master's program I completed undergraduate degree in physics in which I conducted research in topics such as **ab initio quantum chemistry** and using computational methods
