...
Welcome! I'm a Research Fellow with Csaba Szepesvári at the University of Alberta, where I recently defended my MSc thesis on statistical machine learning.
...
to test theoretical models of superconductivity before making the short hop over to computing science for my graduate studies. I've had the opportunity to perform research in assistive robotics and had the incredibly cool experience of designing and implementing a new control scheme on a robotic arm. The focus of my master's research has been studying algorithms and theory for optimal sequential decision making, specifically for problems that fit under the description of <b>pure exploration in multi-armed bandits</b>. Recently I've come full circle and put my physics background to use, working as a research intern at the European Space Agency (ESA) Advanced Concepts Team (ACT), developing **deep learning** models to identify/predict chaos in dynamical systems as well as identifying dynamical systems from sparse data.
